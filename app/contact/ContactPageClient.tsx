            ...
            <div className="rounded-2xl bg-slate-800/30 p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-medium text-slate-300">{t('contactPage.info.email')}</p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-medium text-slate-300">{t('contactPage.info.phone')}</p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-medium text-slate-300">{t('contactPage.info.location')}</p>
                    <p className="text-slate-400">{t('contactPage.info.locationValue')}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl bg-slate-800/30 p-6">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="flex h-12 w-12 items-center justify-center rounded-lg bg-slate-700 text-slate-300 transition-colors hover:bg-slate-600 hover:text-yellow-300"
                  aria-label="GitHub"
                >
